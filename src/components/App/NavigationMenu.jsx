    ...
    let logged = this.props.loggedIn ? (
      <React.Fragment>
        <div className=" d-flex align-items-center dropdown show">
          <a
            className="log-in dropdown-toggle m-3"
            role="button"
            id="dropdownMenuLink"
          ...
          <div
            className="dropdown-menu dropdown-menu-right animated zoomIn"
      ...
      <NavLink
        ...
        className="log-in d-flex align-items-center m-3"
      >
